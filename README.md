...
The current `0.2.0-dev.4` snapshot has substantial new resilience/hardening work and should be locally built/tested before being treated as a stable release or used to advance an app pin.
